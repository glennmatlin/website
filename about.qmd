---
title: "About"
image: assets/media/glenn/headshot.jpeg
about:
  template: trestles
  image-shape: round
  image-width: 15em
  links:
    ...
    - icon: twitter-x
      text: X
      href: https://x.com/glennmatlin
    - text: ORCID
      href: https://orcid.org/0000-0001-6439-6225
    - icon: envelope
      text: Email
      href: "#contact-email"
    - icon: file-earmark-pdf
      text: CV
      href: cv/glenn-matlin-cv.pdf
    - icon: file-text
      text: Resume
      href: cv/glenn-matlin-resume.pdf
---
