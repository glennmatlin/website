...
[Download CV](uploads/cv.pdf){.btn-outline-navy style="border-color: rgba(255,255,255,0.8); color: white; margin-top: 1.5rem;"} [Resume](uploads/resume.pdf){.btn-outline-navy style="border-color: rgba(255,255,255,0.8); color: white; margin-top: 1.5rem;"}
:::
...
[<i class="bi bi-file-pdf"></i> Resume](uploads/resume.pdf){.connect-link}
:::
